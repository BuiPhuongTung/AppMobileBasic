    ...
    return(
        <NavigationContainer>
            <Stack.Navigator initialRouteName="IntroComponent">
                ...
                <Stack.Screen options={{ title: 'Page VNExpress.net' }} name="vnexpress1" component={vnexpress1} />
                <Stack.Screen options={{ title: 'Page bất kỳ từ VNExpress.net' }} name="vnexpress2" component={vnexpress2} />
